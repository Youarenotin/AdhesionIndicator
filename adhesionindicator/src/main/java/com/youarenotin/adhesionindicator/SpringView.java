...
public class SpringView extends View {
    ...
    private Circle headPoint;
    private Circle footPoint;
...
//        float footOffsetY =10;
    ...
    public void animCreate() {
        ...
        ObjectAnimator oaX = ObjectAnimator.ofFloat(this, "scaleX", 0.1f, 1f);
        ObjectAnimator oaY = ObjectAnimator.ofFloat(this, "scaleY", 0.1f, 1f);
    ...
    public Circle getHeadPoint() {
        return headPoint;
    }

    public Circle getFootPoint() {
        return footPoint;
    }
